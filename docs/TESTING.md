...
| `generated-project.integration.test.ts` | Writes a generated project to a temp dir, then runs `tsc --noEmit` over it and executes its generated `npm test` suite — proves the emitted code is valid TypeScript and its tests pass |
